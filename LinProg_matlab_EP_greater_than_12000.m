...
EP = optimvar('EP','LowerBound',12000,'UpperBound',inf);
...
prob = optimproblem('Objective',C_Feul*Feul+C_C*c+C_PP*PP+C_EP*EP,'ObjectiveSense','min');
...
prob.Constraints.c8=-Feul*.75+(HPS)*3163==0;
